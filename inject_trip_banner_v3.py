...
# -*- coding: utf-8 -*-
"""
在每篇文章的 <div class="related-posts"> 前面插入 Trip.com 動態橫幅
最穩健做法：不依賴 FAQ 結構，直接找 related-posts 插入點
"""
...
def process_file(filepath, banner_id, width, height, city_name):
    ...
    # 插入點：<div class="related-posts"> 的前面
    tag = '<div class="related-posts">'
...
def main():
    print("=" * 60)
    print("Trip.com 動態橫幅插入腳本 v3")
    print("插入位置: <div class='related-posts'> 之前")
    print("=" * 60)
