...
if idx == -1:
    print("[ERROR] Heading not found: " + heading)
    exit(1)

print("[OK] Found heading at position: " + str(idx))

# 找到標題結尾（</h2> 後方）
heading_end = idx + len(heading)

# 檢查 </h2> 後方的內容（用於除錯）
next_200_chars = repr(content[heading_end:heading_end+200])
print("[DEBUG] Content after heading (first 200 chars):")
print(next_200_chars)
