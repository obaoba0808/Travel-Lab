# -*- coding: utf-8 -*-
"""
批量補齊 golightly.fun 的 7 個薄內容頁面
按照 tokyo-5days.html 模板結構
"""
...
seoul_5days_article_content = '''<!-- TRIP PROMO BANNER -->
...
<li><strong>缺點</strong>：人潮多、較吵雜、價格稍高</li>
...
<li><strong>参雞参雞湯（삼게탕）</strong>：人蔘雞湯，補身首選，一人約 ₩15,000-20,000</li>
...
<li><strong>紫菜包飯（김밥）</strong>：韓式壽司，₩2,500-4,000</li>
...
print("seoul-5days content defined successfully")
print(f"Length: {len(seoul_5days_article_content)} characters")

# 儲存到檔案供後續使用
with open('seoul_5days_article.txt', 'w', encoding='utf-8') as f:
    f.write(seoul_5days_article_content)

print("Content saved to seoul_5days_article.txt")
