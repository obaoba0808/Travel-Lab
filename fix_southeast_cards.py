...
# Read southeast-asia.html in binary mode
with open('southeast-asia.html', 'rb') as f:
    content = f.read()
...
new_cards = b"""
    ...
    <article class="card">
      ...
      <div class="card-body">
        ...
        <h3><a href="bangkok-massage.html">【曼谷按摩推薦】必試泰式按摩</a></h3>
...
# and insert the new cards before </div> of card-grid
pattern = b'(<article class="card">\s*<a href="bangkok-3days.html">.*?</article>)'
...
if match:
    ...
    with open('southeast-asia.html', 'wb') as f:
        f.write(new_content)
