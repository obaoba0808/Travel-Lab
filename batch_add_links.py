...
def add_affiliate_links(input_pdf, output_pdf):
    ...
    try:
        ...
        print(f'  ❌ Cannot open {input_pdf}: {e}')
        return False
    ...
    for page_num in range(doc.page_count):
        ...
        # Footer 文字（繁体中文）
        footer_text = '📌 更多旅遊攻略 👉 golightly.fun   |   加入 LINE 群組   |   Klook 優惠   |   Trip.com 優惠'
        ...
        if 'japan' in pdf_name or 'tokyo' in pdf_name or 'kyoto' in pdf_name or 'osaka' in pdf_name or 'kansai' in pdf_name or 'usj' in pdf_name or 'hokkaido' in pdf_name or 'okinawa' in pdf_name:
            if page_num == min(2, doc.page_count - 1):  # 前3页之一
                ...
                tip_text = '💡 編輯推薦：我們在 Klook 上幫你比價過，通常比官網便宜 5-10%，點此查看今日優惠'
        ...
        # 韓国相关 PDF：添加 Klook 链接
            ...
            if page_num == min(2, doc.page_count - 1):
                ...
                tip_text = '💡 省錢技巧：在 Klook 購買通常比現場便宜，點此查看今日優惠'
        ...
        # 泰国/东南亚 PDF：添加 Klook 链接
            ...
            if page_num == min(2, doc.page_count - 1):
                ...
                tip_text = '💡 推薦：在 Klook 上預訂通常更便宜，點此查看今日優惠'
        ...
        # 台湾 PDF：添加 Klook 酒店链接
            ...
            if page_num == min(2, doc.page_count - 1):
                ...
                tip_text = '💡 推薦：在 Klook 上訂酒店通常有獨家優惠，點此查看'
    ...
    try:
        ...
        print(f'  ❌ Save failed {output_pdf}: {e}')
        doc.close()
        return False
...
if __name__ == '__main__':
    ...
    print(f'📊 找到 {len(pdf_files)} 个 PDF 需要处理')
    print('=' * 60)
    ...
    print(f'📊 总共处理: {len(pdf_files)} 个 PDF')
