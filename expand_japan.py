...
<section style="max-width:900px;margin:0 auto;padding:0 20px 40px;">
  ...
  <p style="line-height:1.9;margin-bottom:12px;"><strong>關西（大阪+京都+神戶）</strong><br>如果你喜歡古都氛圍和美食，關西絕對是首選。大阪是「日本的廚房」，章魚燒、大阪燒、串炸... 吃都吃不完。京都則是完全不同的感覺——千年古都的楓紅和寺廟，讓人覺得時間慢了下來。我的私房推薦：京都站烏丸側有个「京都拉麵小路」，吃到飽的拉麵套餐只要 ¥1,200，每次去都吃。</p>
  ...
  <p style="line-height:1.9;margin-bottom:16px;">5. <strong>不要安排太滿</strong>：很多人第一次去日本想把東京塞在3天內逛完，結果每天都在趕行程。留點空白時間，隨便走進一個小神社或咖啡廳，往往會有意外的驚喜。我最重要的一課：在京都某個不知名的小巷子里，發現了一家只賣抹茶冰淇淋的小店——那一顆抹茶冰淇淋，比我吃過的任何米其林甜點都難忘。</p>
  ...
  <p style="line-height:1.9;margin-bottom:16px;">不含機票，5天4夜大概抓 NT$25,000~35,000 就很舒服了。如果願意住青旅、吃便利商店、用廉航，甚至可以壓到 NT$18,000 以内。我自己的紀錄是：5天4夜東京，總花費 NT$16,000（含機票！）——那次是搭虎航來回 NT$4,800，住宿全程青旅，交通全用 Tokyo Subway Ticket。</p>

  <p style="line-height:1.9;margin-bottom:16px;font-style:italic;color:var(--text-light);">👉 往下看我們整理的詳細攻略，每一篇都是實地走訪後寫出來的——不是抄来的，是真正走過、吃過、住過之後的心得。</p>
</section>
'''

# Insert after hero-title-block's closing </div>
import re
hero_end = c.find('</div>\n<!-- MAIN CONTENT -->')
if hero_end >= 0:
    insert_pos = hero_end + len('</div>')
    c = c[:insert_pos] + '\n' + new_content + '\n' + c[insert_pos:]
